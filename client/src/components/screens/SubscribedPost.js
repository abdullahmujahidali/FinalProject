...
export default function SubscribedPost() {
    ...
    <>
      <section className="bg-white text-black body-font overflow-hidden ">
        <div className="container px-5 pb-32 pt-2 mx-auto">
          <h1 className="sm:text-2xl text-5xl title-font font-medium mt-4 mb-4 extra-bold text-center rounded-xl">FOLLOWING POSTS</h1>
